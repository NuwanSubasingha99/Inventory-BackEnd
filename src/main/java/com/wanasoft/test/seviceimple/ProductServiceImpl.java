...
import com.wanasoft.test.POJO.Product;
import com.wanasoft.test.constents.CafeConstants;
import com.wanasoft.test.dao.ProductDao;
import com.wanasoft.test.service.ProductService;
import com.wanasoft.test.utils.CafeUtils;
import com.wanasoft.test.wrapper.ProductWrapper;
		...
		try {
			...
			if(jwtFilter.isAdmin()) {
				...
				if(validateProductMap(requestMap,false)) {
					...
					return CafeUtils.grtResponseEntity("Product Added Successfully", HttpStatus.OK);
			...
			if(jwtFilter.isAdmin()) {
				...
				if(validateProductMap(requestMap, true)) {
					...
					if(!optional.isEmpty()) {
						...
						return CafeUtils.grtResponseEntity("Product Updated Successfully", HttpStatus.OK);
						
					}else {
						return CafeUtils.grtResponseEntity("Product ID doesnt exist", HttpStatus.OK);
					}
		...
		try {
			...
			if(jwtFilter.isAdmin()) {
				...
				if(!optional.isEmpty()) {
					...
					return CafeUtils.grtResponseEntity("Product Deleted Successfully", HttpStatus.OK);
		...
		try {
			...
			if (jwtFilter.isAdmin()) {
				...
				if(!optional.isEmpty()) {
					...
					return CafeUtils.grtResponseEntity("Product Status Updated Successfully", HttpStatus.OK);
